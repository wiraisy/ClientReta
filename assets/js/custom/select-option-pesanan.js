$(document).ready(function() {
    $('#selectPesananSebelum').change(function() {
        ...
        var custid_user = $('select[name="selectPesananSebelum"] :selected').attr('class');
