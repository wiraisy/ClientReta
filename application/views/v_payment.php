...
<?php echo date("d-M-Y h:i:s", (1645961613028/1000) ) ?>
<!-- CountDown Js -->
<script src="<?= base_url() ?>assets/js/plugins/moment.min.js"></script>
<script>
    // Get Countdown Date from table countdownend
    // var countDownDate = date.getTime() + 3*60000;
    const countDownEnd = <?php echo strtotime("".$countdown_end[0]['date']." ".$countdown_end[0]['hour'].":".$countdown_end[0]['minutes'].":".$countdown_end[0]['seconds']) ?> * 1000 ;
