...
class Auth extends MY_Controller {
	...
	public function loginmember()
	{
		...
		// Validasi No. KTP
		$url = $this->_apiURL . "PasienAPI/validasiktppasien/" . $hp1 . "/" . $noktp;
        $method = 'PUT';
        $cek_ktp = $this->SendRequest($url, $method);
		...
		if ($cek_ktp != null) {
			...
			// Error Message KTP
			$this->session->set_flashdata('error', 'No. KTP Tidak Terdaftar, Login Gagal!');
			redirect(base_url() . 'auth/member');
		}
	}
