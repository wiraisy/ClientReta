                ...
                <div class="card">
                    <div class="card-header bg-transparent">
                        ...
                        <form action="<?= base_url("admin/tambahAdmin") ?>" method="POST">
                            <div class="row">
                                    <div class="col-4">
                                        <input type="text" name="username" placeholder="Username" class="form-control form-control-alternative">
                                    </div>
                                    <div class="col-4">
                                        <input type="text" name="password" placeholder="Password" class="form-control form-control-alternative">
                                    </div>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?= base_url('admin/ubah'); ?>/<?= $row['idadmin']; ?>" method="POST"  enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <input type="text" name="name" class="form-control" value="<?= $row['username']; ?>" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="" class="col-sm-4 col-form-label">Password Baru</label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" name="password" class="form-control" placeholder="Masukkan Password Baru" value="<?= $row['username']; ?>">
                                                                        </div>
                                                                    </div>
