                ...
                <div class="card-header bg-transparent">
                    ...
                    <div class="paging-section my-2">
                        <ul id="pagination-custom">
                            ...
                            <li><a class="" href="<?= base_url() ?>produk-andalan/<?=  $produk['pageable']['pageNumber'] ?>">«</a></li>
                            <?php endif; ?>
                            <?php for ($i=1; $i <= $produk['totalPages']; $i++) {  ?>
                                <li><a href="<?= base_url() ?>produk-andalan/<?= $i ?>" class="<?= ($produk['pageable']['pageNumber'] == $i-1) ? 'active' : '' ?>"><?= $i ?></a></li>
                            <?php } ?>
                            <?php $pageNow = $produk['pageable']['pageNumber'] + 1;
                            if($pageNow != $produk['totalPages']): ?>
                            <li><a href="<?= base_url() ?>produk-andalan/<?=  $produk['pageable']['pageNumber'] + 2 ?>">»</a></li>
                            <?php endif; ?>
                        </ul> 
                    </div>
                    <!-- Produk -->
                                        ...
                                        <div class="col-md-6 row mt-2 py-4" style="border-bottom: 1px solid grey;">
                                            <div class="col-md-6" >
                                                <div class="img-wrap">
                                                    ...
                                                    ?>
                                                    <a class="test-popup-link" href="<?= $src; ?>"><img src="<?= $src; ?>" id="img-produk-<?= $rows['idproduk'] ?>" alt="Rounded image" class="rounded"></a>
